...
public final class Results {
    ...
    public static <T> Result<T> error(ServiceErrorException e) {
        return new DefaultResult<T>().setCode(e.getCode()).setMessage(e.getMessage())
                .setErrorClass(e.getClass().getName()).setErrorStack(ThrowableUtils.getStackTrace(e));
    }
    ...
    public static <T> Result<T> error(ErrorCode errorCode, Throwable throwable) {
        return new DefaultResult<T>().setCode(errorCode.code()).setMessage(errorCode.code())
                .setErrorClass(throwable.getClass().getName()).setErrorStack(ThrowableUtils.getStackTrace(throwable));
    }
    ...
    public static <T> Result<T> error(String code, String message, String errorClass) {
        return new DefaultResult<T>().setCode(code).setMessage(message).setErrorClass(errorClass);
    }
